...
Return ONLY a JSON array of relevant political developments found. Only include real news from credible sources. Each entry must be unique - no duplicates. Do not include any text before or after the JSON array.`,
            ...
            for (const entry of validEntries) {
                ...
                const processedEntry = {
                    // Note: id is auto-generated by database (SERIAL PRIMARY KEY) - DO NOT SET IT!
                    date: entry.date,
                    ...
                    // REMOVED: manual_submission field doesn't exist in DB
                    added_at: new Date().toISOString(),
                    // Add spicy summary fields (these DO exist in the DB)
                    // Using optional chaining (?.) to safely handle null/undefined spicyEnhanced
                    spicy_summary: spicyEnhanced?.spicy_summary || null,
                    shareable_hook: spicyEnhanced?.shareable_hook || null,
                    severity_label_inapp: spicyEnhanced?.severity_label_inapp || null,
                    severity_label_share: spicyEnhanced?.severity_label_share || null
                    // REMOVED: impact_type field - that's for executive orders, not political entries
                };

-- ============================================================================
-- SEED: Compliance Rules for Existing Feeds
-- ============================================================================
...
VALUES 
  ...
  -- Test Feed (allow full text for testing)
  (6, 'Test Feed', TRUE, 0, 
   'Test feed - allow full content for development/QA')
...
-- - Test feed allows full text
--
-- ➡️ Next step: Run 07_post_deployment_verification.sql
--
-- ============================================================================

-- Migration 021a: Lower clustering threshold for testing
-- Current: threshold = 65, but pg_trgm similarity may be lower than expected
-- Testing with threshold = 50 to see if any articles cluster
...
'Story clustering with actual similarity scoring (TESTING with threshold=50).
Scoring: URL(30) + Title(0-45) + Date(0-10) + Actor(5) = max 90 points.
Threshold: 50 points (LOWERED from 65 for testing).

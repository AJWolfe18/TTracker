-- TrumpyTracker Critical Migration v3.1
-- TTRC-160: Database Schema Fixes
-- ⚠️ THIS MUST RUN FIRST - System will fail without these fixes
-- 
-- Run this on both TEST and PRODUCTION databases:
-- Test DB: wnrjrywpcadwutfykflu
-- Prod DB: osjbulmltfpcoldydexg
